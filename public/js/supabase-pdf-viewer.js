(function () {
  ...
  async function loadPdf() {
    ...
    container.addEventListener('change', event => {
      ...
      if (event.target === pageInput || event.target === zoomSelect) renderPage();
    });
