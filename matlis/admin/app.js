...
function setPdfEditMode(pdf) {
  ...
  document.querySelector('#editPdfArticleShellId').value = pdf.article_shell_id || '';
...
pdfEditForm.addEventListener('submit', async event => {
  ...
  const values = {
    ...
    article_shell_id: Number(document.querySelector('#editPdfArticleShellId').value) || null,
